    ...
    try {
        ...
        String cdate = new java.text.SimpleDateFormat("dd/MM/yyyy hh:mm:ss").format(new java.util.Date());
          ...
          if (cm.executeNonQuery(query)==true)
          {
            ...
            response.sendRedirect("adminzone/materialupload.jsp?s=save"); 
          }
          else
          {
             response.sendRedirect("adminzone/materialupload.jsp?s=not"); 
          }
        } catch (IOException | ServletException | SQLException | ClassNotFoundException e) {
            response.sendRedirect("adminzone/materialupload.jsp?err="+e);
        }
    }
