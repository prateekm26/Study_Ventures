...
<%
    ...
    {
    out.print("<script>alert ('Your feedback is submitted successfully');window.location.href='../studentzone/feedback.jsp'</script>");
    }
    else
    {
        out.print("<script>alert ('Database Err');window.location.href='../studentzone/feedback.jsp'</script>");
    }
