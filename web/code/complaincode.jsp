...
<%
    ...
    {
    out.print("<script>alert ('Your complain is submitted successfully');window.location.href='../studentzone/complain.jsp'</script>");
    }
    else
    {
        out.print("<script>alert ('Database Err');window.location.href='../studentzone/complain.jsp'</script>");
    }
