<%-- 
    Document   : consultant_mgmt
    Created on : 7 Nov, 2017, 9:31:27 PM
    ...
    <body >
        ...
        <div id="wrapper">
            <div id="header">
                ...
                String q="select * from consultant_registration";
             ...
             <tr>
                 ...
                 <td><a href="admincode/usermanagementcode.jsp?username=<%=rs.getString(7)%>">delete</a></td>
                        </tr>
                 <%
                 n++;
                }
