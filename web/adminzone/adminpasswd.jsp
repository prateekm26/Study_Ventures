<%-- 
    ...
    Created on : 5 Nov, 2017, 9:20:19 PM
...
<html>
    ...
    <body >
        ...
        <form action="admincode/adminchangepasswdcode.jsp" method="post">
            <%
        ...
        <div id="wrapper">
            <div id="header">
                ...
                <div id="main"style="//background-image: url('images/wll.jpg'); background-repeat: no-repeat;
                    ...
                    <div id="content">
                         <h2 style="color:whitesmoke;text-align: center;">CHANGE PASSWORD</h2>
                    <table align="center">
                        <tr>
                        ...
                        <tr><th>&nbsp;</td><th><input type="submit" name="changepassword" value="Change Password"/><th></tr>
                    </table></div>
                </div>
