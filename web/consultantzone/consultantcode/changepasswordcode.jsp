...
<%
   ...
   if (newpassword.equals(confirmpassword))
   {
    ...
    String query1="update login set passwd='"+newpassword+"' where userid='"+userid+"' and passwd='"+oldpassword+"'";
     String query2="update consultant_registration set passwd='"+newpassword+"' where username='"+userid+"' and passwd='"+oldpassword+"'";
     ConnectionManager cm=new ConnectionManager();
     if(cm.executeNonQuery(query1))
     {
     if (cm.executeNonQuery(query2))   
     {
         out.print("<script>alert('Password updated');window.location.href='../consultant_home.jsp';</script>");
     }
     else
        {
